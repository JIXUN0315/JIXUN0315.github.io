...
namespace Hatsukoi.Repository.Migrations
{
    ...
    [Migration("20230314105152_editAdminTableName")]
    partial class editAdminTableName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hatsukoi.Repository.EntityModel.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hatsukoi.Repository.EntityModel.Reviewer", b =>
                {
                    b.HasOne("Hatsukoi.Repository.EntityModel.Admin", "Administrator")
                        .WithMany("Reviewers")
